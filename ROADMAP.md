...
- [x] **Tarefa 3.3** — Filtro de validação de token nas requisições
...
- [x] **Tarefa 6.2** — Fluxo client credentials para microsserviços consumidores

## Fase 7 — Segurança Avançada

- [x] **Tarefa 7.1** — Rate limiting
- [x] **Tarefa 7.2** — Proteção contra brute force
- [x] **Tarefa 7.3** — Auditoria de eventos de segurança (login, falha de login, troca de senha)
- [x] **Tarefa 7.4** — MFA (extensão opcional)

## Fase 8 — Testes

- [x] **Tarefa 8.1** — Testes unitários (JUnit)
- [x] **Tarefa 8.2** — Testes de integração com Testcontainers (Postgres + Redis reais)
- [x] **Tarefa 8.3** — Testes de segurança dos endpoints
